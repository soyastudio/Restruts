...
public class SpreadSheetAction extends DocumentAction<XlxsDynaClass> {
    ...
    @Override
    public XlxsDynaClass execute() throws Exception {
        ...
        return new XlxsDynaClass(file.getName(), properties, file, sheet);
    }
}
